...
1. **Java Development Kit (JDK):** Make sure to have Java SE Development Kit (JDK) 8 or higher installed on your system.
...
For the compilation of Java files, follow these steps:
