...
public class SaxParserDataStore extends DefaultHandler {
	...
	static HashMap<String, Thermo> thermos;
	static HashMap<String, Light> lights;
	...
	public SaxParserDataStore(String consoleXmlFileName) {
		...
		thermos = new HashMap<String, Thermo>();
	...
	public void startElement(String str1, String str2, String elementName, Attributes attributes) throws SAXException {
		...
		if (elementName.equalsIgnoreCase("thermo")) {
			currentElement = "thermo";
			thermo = new Thermo();
			thermo.setId(attributes.getValue("id"));
		}
	...
	public void endElement(String str1, String str2, String element) throws SAXException {
		...
		if (element.equals("thermo")) {
			thermos.put(thermo.getId(), thermo);
			return;
		}
		...
		if (element.equalsIgnoreCase("image")) {
			...
			if (currentElement.equals("thermo"))
				thermo.setImage(elementValueRead);
		...
		if (element.equalsIgnoreCase("discount")) {
			...
			if (currentElement.equals("thermo"))
				thermo.setDiscount(Double.parseDouble(elementValueRead));
			if (currentElement.equals("light"))
		...
		if (element.equalsIgnoreCase("condition")) {
			...
			if (currentElement.equals("thermo"))
				thermo.setCondition(elementValueRead);
			if (currentElement.equals("light"))
		...
		if (element.equalsIgnoreCase("manufacturer")) {
			...
			if (currentElement.equals("thermo"))
				thermo.setRetailer(elementValueRead);
			if (currentElement.equals("light"))
		...
		if (element.equalsIgnoreCase("name")) {
			...
			if (currentElement.equals("thermo"))
				thermo.setName(elementValueRead);
			if (currentElement.equals("light"))
		...
		if (element.equalsIgnoreCase("price")) {
			...
			if (currentElement.equals("thermo"))
				thermo.setPrice(Double.parseDouble(elementValueRead));
			if (currentElement.equals("light"))
