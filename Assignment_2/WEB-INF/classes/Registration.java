	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			else
			{
				...
				User user = new User(username,password,usertype,Street,City,State,ZipCode);
				hm.put(username, user);
				MySqlDataStoreUtilities.insertUser(username,password,repassword,usertype,Street,City,State,ZipCode);					
