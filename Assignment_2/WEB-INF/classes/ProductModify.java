	...
	protected void doGet(HttpServletRequest request,
		...
		if (action.equals("Addproduct")) {
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='consoles' selected>Doorbell</option><option value='games'>Doorlock</option><option value='tablets'>Speaker</option><option value='lights'>Light</option><option value='thermos'>Thermostat</option></select>"
					+ "</td></tr><tr><td>"
					...
					+ "</td></tr><tr><td>"
					+ "<h3>Count</h3></td><td><input type='number' step='any' placeholder='please enter numeric data' name='count' value='' class='input' required></input>"
					+ "</td></tr><tr><td>"
					+ "<h3>Rebat</h3></td><td><label><input type='radio' name='yesno' value='yes'> Yes</label></td>"
					+ "<td><label><input type='radio' name='yesno' value='no'> No</label>"
					+ "</td></tr><tr><td>"
